...
|`rollingPolicy`
|none
|An object that defines a log rotation policy. Examples are given <<Rolling Policy,below>>.

|`filters`
|none
|A collection of filters to use with this appender. See <<Filters, filters>> section.
|===
